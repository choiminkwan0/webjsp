...
<div class="container py-4">
    ...
    <%
        ...
        FacilityDTO facility = facilityDAO.getFacilityDTOByName(name);
    %>
                ...
                <div class="row g-0 align-items-stretch">
                    ...
                    <div class="col-md-7 d-flex align-items-center">
                        <div class="card-body p-5 text-start w-100">
                            ...
                            <div class="pt-2">
                                <form name="reserveForm" action="./reserve.jsp?name=<%=facility.getFacilityName() %>" method="post">
                                    <button type="button" class="btn btn-warning px-4 py-2 fw-bold text-dark me-2" onclick="reserve()">
                                        예약하기 &raquo;
                                    </button>
                                </form>
                                <a href="./facilitys.jsp" class="btn btn-outline-secondary px-4 py-2" role="button">
                                    &laquo; 시설 목록 돌아가기
                                </a>
                            </div>
