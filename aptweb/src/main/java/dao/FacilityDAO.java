...
public class FacilityDAO {
    ...
    public FacilityDAO() {
        ...
        facilityDTO1.setDescription("사설 헬스장보다 이용료가 훨씬 저렴하지만 아파트 입주민만 사용할 수 있습니다.");
        facilityDTO1.setCondition("가능");
        facilityDTO1.setPeopleInStock(20);
        facilityDTO1.setFileName("facility01.jpg");

        FacilityDTO facilityDTO2 = new FacilityDTO(1, "독서실", 1000);
        facilityDTO2.setDescription("사설 독서실보다 이용료가 훨씬 저렴하지만 아파트 입주민만 사용할 수 있습니다.");
        facilityDTO2.setCondition("가능");
        facilityDTO2.setPeopleInStock(30);
        facilityDTO2.setFileName("facility02.jpg");

        FacilityDTO facilityDTO3 = new FacilityDTO(1, "게스트하우스", 10000);
        facilityDTO3.setDescription("입주민의 친척이나 지인이 방문했을 때 저렴한 비용으로 편안하게 머무를 수 있도록 단지 내에 마련된 숙박 시설입니다.");
        facilityDTO3.setCondition("가능");
